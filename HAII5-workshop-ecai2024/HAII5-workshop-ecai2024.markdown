...
| 15:10–15:30 | * Understanding the Impact of Unexpected Cobot Movements on Human Stress Levels: A Time Series Classification Task, *Lior Shilon (SCE), Vladyslav Shevtsov (SCE), Nadia Schillreff (OVGU), Anne Rother (OVGU), Shlomo Mark (SCE), Myra Spiliopoulou (OVGU)* |
